...
layout: HubPage
hide_bc: true
title: Node.js 开发人员中心 | Microsoft Docs
description: 了解如何使用 Azure 在云中开发和部署 Node.js 应用程序。
ms.topic: hub-page
...
ms.locfileid: "48981771"
---
<div id="main" class="v2">
    <div class="container">
        <h1 style="text-align: center">Node.js 开发人员中心</h1> 
        <p style="text-align: center">在 Azure 云中生成、部署和缩放 Node.js 应用程序。</p>
...
brew install azure-cli az login az group create --name MyResourceGroup --location &quot;美国西部&quot; </code></pre>
